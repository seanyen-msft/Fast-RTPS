...
public:
    ...
    virtual bool send(const octet* sendBuffer, uint32_t sendBufferSize, eProsimaUDPSocket& socket,
            const Locator_t& remoteLocator, bool only_multicast_purpose) override;
