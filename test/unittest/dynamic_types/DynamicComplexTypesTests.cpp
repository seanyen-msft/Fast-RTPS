...
{
    const TypeObject* compl_obj = TypeObjectFactory::GetInstance()->GetTypeObject("CompleteStruct", true);
    const TypeInformation* info = TypeObjectFactory::GetInstance()->GetTypeInformation("CompleteStruct");
    ...
    const TypeInformation* enum_info = TypeObjectFactory::GetInstance()->GetTypeInformation("MyAliasEnum");
    ASSERT_TRUE(enum_info->minimal().typeid_with_size().type_id()._d() == EK_MINIMAL);
    const TypeInformation* bool_info = TypeObjectFactory::GetInstance()->GetTypeInformation("bool");
